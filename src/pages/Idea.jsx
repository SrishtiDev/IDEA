        ...
        {!ideas ? (
          ...
          >
            ...
            <div className="relative z-10">
              <h2
                className="text-2xl sm:text-3xl font-semibold mb-2 font-['Space_Grotesk'] tracking-tight"
                style={{ color: "#E1E0CC" }}
              >
                Generate Idea
              </h2>
              <p className="text-sm text-gray-300 mb-8 font-['Manrope']">
                Tell us about your stack and preferences to get a tailored
                project idea.
              </p>
              ...
              <form onSubmit={handleGenerate} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    ...
                    <option value="cyber" className="bg-slate-900 text-white">
                      Cybersecurity
                    </option>
                ...
                <div className="flex flex-col gap-2">
                  <label
                    ...
                    className="text-xs font-semibold tracking-wider text-gray-400 uppercase flex items-center justify-between"
                  >
          ...
          >
            ...
            <div className="absolute -inset-x-20 inset-y-0 pointer-events-none overflow-hidden z-0 opacity-10">
              <span
                className="material-symbols-outlined absolute top-1/4 -left-10 text-8xl text-primary animate-pulse"
                style={{ transform: "rotate(-15deg)" }}
              >
                hub
              </span>
              <span
                className="material-symbols-outlined absolute top-1/3 -right-10 text-9xl text-secondary animate-pulse"
                style={{ transform: "rotate(10deg)" }}
              >
                cloud_done
              </span>
              <span
                className="material-symbols-outlined absolute bottom-1/4 -left-10 text-7xl text-tertiary animate-pulse"
                style={{ transform: "rotate(25deg)" }}
              >
                security
              </span>
              <span
                className="material-symbols-outlined absolute bottom-1/3 -right-10 text-8xl text-primary animate-pulse"
            ...
            <div className="flex items-center justify-between relative z-10">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold font-['Space_Grotesk'] text-[#E1E0CC] tracking-tight">
                  Generated Ideas
                </h2>
                <p className="text-gray-400 font-['Manrope'] mt-2 text-lg">
                  Based on your {techStack} stack
                </p>
              </div>
              <button
              ...
              {ideas.map((idea, i) => (
                ...
                >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <h3 className="text-2xl font-bold font-['Space_Grotesk'] text-[#E1E0CC] group-hover:text-primary transition-colors">
                      {idea.title}
                    </h3>
                  </div>
                  ...
                  <div className="flex justify-between items-center pt-6 border-t border-white/5">
                    <div className="flex gap-2">
                      <span className="px-3 py-1 rounded-full bg-white/5 text-[10px] text-gray-400 uppercase tracking-widest border border-white/5">
                        Project
                      </span>
                    </div>
